...
public class ViewNewAccount {
	...
	*/
	...
	private ViewNewAccount() {
		...
		// If the passwords do not match, this alert dialog will tell the user
		alertUsernameError.setTitle("Username does not meet requirements");
		alertUsernameError.setHeaderText("The username must meet requirements");
		alertUsernameError.setContentText("Correct the username and try again.");
		
		// If the passwords do not match, this alert dialog will tell the user
		alertPasswordError.setTitle("Passwords Do Not Meet Requirements");
		alertPasswordError.setHeaderText("The two passwords must meet requirements.");
